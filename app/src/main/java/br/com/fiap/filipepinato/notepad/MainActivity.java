package br.com.fiap.filipepinato.notepad;
...
import br.com.fiap.filipepinato.notepad.api.NotaAPI;
    ...
    private void salvar(){
        ...
        service.salvar(nota).enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(getApplicationContext(), "Nota gravada", Toast.LENGTH_SHORT).show();
            }
